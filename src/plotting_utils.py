...
def scatter_residual_analysis(data: pd.DataFrame) -> go.Figure:
    ...
    fig = px.scatter(data, x="alcohol", y="volatile acidity", animation_frame="quality", color='residual_size', size='sulphates', color_continuous_scale='RdBu', range_color=[-2, 2], hover_data=['residual_size'])
